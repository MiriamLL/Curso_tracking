...
Para esta parte necesitas saber cargar tus datos, si necesitas recordar como hacerlo, te recomiendo [`r fa("external-link-alt", fill = "#22577a")`empezar por aquí](https://miriamll.github.io/Curso_tracking/Parte1).
...
Otra opción es ver la [`r fa("external-link-alt", fill = "#22577a")`lista en Wikipedia](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones).
...
- mi [`r fa("external-link-alt", fill = "#22577a")`github](https://github.com/MiriamLL/Curso_tracking/).
