...
```{r}
GPS_Todos$diahora<-paste(GPS_Todos$DateGMT,GPS_Todos$TimeGMT)
```

Para decirle que son día y hora:
```{r}
GPS_Todos$diahora<-as.POSIXct(strptime(GPS_Todos$diahora, 
                                       "%d/%m/%Y %H:%M:%S"),"GMT")
```
