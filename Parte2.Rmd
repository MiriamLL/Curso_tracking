...
- Tienen conocimientos básicos de R, si no te recomiendo [`r fa("external-link-alt", fill = "#52b788")`empezar por aquí](https://miriamlerma.netlify.app/posts/2021-03-01-introar/) <br>
...
Para esta parte necesitas saber cargar tus datos, si necesitas recordar como hacerlo, te recomiendo [`r fa("external-link-alt", fill = "#52b788")`empezar por aquí](https://miriamll.github.io/Curso_tracking/Parte1).
...
```
Si quieres descargar los archivos de prueba [`r fa("external-link-alt", fill = "#52b788")`ve aquí](https://github.com/MiriamLL/Curso_tracking/tree/main/01Datos).
...
Para esta parte puedes necesitar algunos básicos de como manipular data frames en R, si necesitas más información [`r fa("external-link-alt", fill = "#52b788")`ve aquí](https://miriamll.github.io/Curso_CIAD/Clase3Parte2#1).
...
Otra opción es ver la [`r fa("external-link-alt", fill = "#52b788")`lista en Wikipedia](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones).
...
# 4. Exportar 
Para esta parte necesitas saber cargar tus datos, si necesitas recordar como hacerlo, te recomiendo [`r fa("external-link-alt", fill = "#52b788")`empezar por aquí](https://miriamll.github.io/Curso_CIAD/Clase3Parte2#54).
...
- mi [`r fa("external-link-alt", fill = "#52b788")`github](https://github.com/MiriamLL/Curso_tracking/).

<br>

Si quieres dar créditos puedes usar:
- Lerma M, 2021. Clase biologging. Próximamente con zenodo. 
- Lerma M, Dehnhard N, Luna-Jorquera G, Voigt CC, Garthe SS (2020) Breeding stage, not sex, affects foraging characteristics in masked boobies at Rapa Nui. Behavioral ecology and sociobiology 74: 149 [`r fa("external-link-alt", fill = "#52b788")`OpenAccess](https://link.springer.com/article/10.1007/s00265-020-02921-1)<br>
