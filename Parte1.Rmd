...
- Tienen conocimientos básicos de R, si no te recomiendo [`r fa("external-link-alt", fill = "#22577a")`empezar por aquí ](https://miriamlerma.netlify.app/posts/2021-03-01-introar/) <br>
...
Para esta parte necesitas saber instalar paquetes, si necesitas recordar como hacerlo, te recomiendo [`r fa("external-link-alt", fill = "#22577a")`empezar por aquí](https://miriamll.github.io/Curso_CIAD/Clase1Parte2).
...
```
Si quieres descargar los archivos de prueba [`r fa("external-link-alt", fill = "#22577a")`ve aquí](https://github.com/MiriamLL/Curso_tracking/tree/main/01Datos).
...
## 2. Recortar
Para esta parte puedes necesitar algunos básicos de como manipular data frames en R, si necesitas más información [`r fa("external-link-alt", fill = "#22577a")`ve aquí](https://miriamll.github.io/Curso_CIAD/Clase3Parte2#1).
...
## 3. Graficar
Para recordar los básicos de como realizar gráficos en R [`r fa("external-link-alt", fill = "#22577a")`ve aquí](https://miriamll.github.io/Curso_CIAD/Clase2#1).
...
# 4. Exportar 
Para esta parte necesitas saber cargar tus datos, si necesitas recordar como hacerlo, te recomiendo [`r fa("external-link-alt", fill = "#22577a")`empezar por aquí](https://miriamll.github.io/Curso_CIAD/Clase3Parte2#54).
...
- Este material esta accesible y se encuentra en mi [`r fa("external-link-alt", fill = "#22577a")`github](https://github.com/MiriamLL/Curso_tracking/).

<br>

Si quieres dar créditos puedes usar:
- Lerma M, 2021. Clase biologging. 
- Lerma M, Dehnhard N, Luna-Jorquera G, Voigt CC, Garthe S (2020) Breeding stage, not sex, affects foraging characteristics in masked boobies at Rapa Nui. Behavioral ecology and sociobiology 74: 149 [`r fa("external-link-alt", fill = "#22577a")`OpenAccess](https://link.springer.com/article/10.1007/s00265-020-02921-1). <br>
**Los datos de prueba vienen de esta publicación. **
